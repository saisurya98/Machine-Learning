...
para["bias"] = 0
learning_rate=0.01
print('Leave one out validation score with age column is ', validation(X, Y, para))

if __name__ == "__main__":
    main()

# The accuracy with logistic regression when LOCV is 51.66% , for KNN and naive bayes algorithm(65% , 70%)
